    ...
    <div className="p-4 lg:p-6 pb-24 lg:pb-6 space-y-6">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="flex items-center gap-3 mb-2 relative z-10">
          ...
          <div>
            <h1 className="text-2xl font-display font-bold text-white">Community Forums</h1>
            <p className="text-sm text-white/60">Discuss. Support. Share. Anonymous options available.</p>
          </div>
        </div>
      </motion.div>
