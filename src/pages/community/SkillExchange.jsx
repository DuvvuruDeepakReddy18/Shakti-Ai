...
const DEMO_EXCHANGES = [
  { id: 1, teaching: 'Python Programming', wants: 'Spoken English', by: 'Priya S.', rating: 4.9, swaps: 12, avatar: 'bg-[var(--color-shakti-primary)]' },
  { id: 2, teaching: 'Cooking (South Indian)', wants: 'Graphic Design', by: 'Meera K.', rating: 4.8, swaps: 23, avatar: 'bg-[var(--color-shakti-secondary)]' },
  { id: 3, teaching: 'Yoga & Meditation', wants: 'Digital Marketing', by: 'Anita T.', rating: 5.0, swaps: 18, avatar: 'bg-[var(--color-shakti-success)]' },
  { id: 4, teaching: 'React Development', wants: 'UI/UX Design', by: 'Riya M.', rating: 4.7, swaps: 8, avatar: 'bg-[var(--color-shakti-accent)]' },
  { id: 5, teaching: 'Hindi Tutoring', wants: 'Photography', by: 'Kavitha R.', rating: 4.9, swaps: 34, avatar: 'bg-[var(--color-shakti-warning)]' },
  { id: 6, teaching: 'Embroidery & Crafts', wants: 'Social Media Management', by: 'Rekha D.', rating: 4.6, swaps: 15, avatar: 'bg-[var(--color-shakti-error)]' },
];
  ...
  return (
    <div className="p-4 lg:p-6 pb-24 lg:pb-6 space-y-6">
      <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="absolute -bottom-10 -right-10 w-48 h-48 bg-pink-500/15 rounded-full blur-3xl pointer-events-none" />
        <div className="flex items-center gap-3 mb-2 relative z-10">
          <div className="w-12 h-12 rounded-[1rem] bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center text-violet-400 shadow-lg shadow-violet-500/10">
            <Repeat size={24} />
          </div>
          <div>
            <h1 className="text-2xl font-display font-bold text-white">Skill Exchange</h1>
            <p className="text-sm text-white/60">Trade skills with other women. Learn without spending.</p>
          </div>
        </div>
      </motion.div>

      <button onClick={() => setShowForm(!showForm)}
        className="w-full py-3 rounded-xl gradient-bg text-white font-semibold flex items-center justify-center gap-2 shadow-lg shadow-[var(--color-shakti-primary)]/20">
      ...
      {showForm && (
        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} className="card-static p-5 space-y-3">
          <div>
            <label className="text-xs font-semibold text-[var(--color-shakti-success)] mb-1.5 block">I can teach</label>
          ...
          <div className="flex justify-center">
            <ArrowLeftRight size={20} className="text-[var(--color-shakti-primary)]" />
          </div>
          <div>
            <label className="text-xs font-semibold text-[var(--color-shakti-primary)] mb-1.5 block">I want to learn</label>
          ...
          <motion.div key={e.id} initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: i * 0.05 }}
            ...
            <div className="flex items-center gap-3 mb-3">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-1 text-[10px] text-[var(--color-shakti-dark-muted)]">
                  <Star size={10} className="text-[var(--color-shakti-warning)] fill-[var(--color-shakti-warning)]" /> {e.rating} · {e.swaps} swaps
                </div>
              </div>
            </div>
            ...
            <div className="bg-[var(--color-shakti-dark-surface)] rounded-xl p-3 mb-3">
              <div className="flex items-center gap-2 mb-2">
                <span className="text-[10px] text-[var(--color-shakti-success)] font-semibold uppercase">Teaches</span>
                <span className="text-sm text-[var(--color-shakti-dark-text)] font-medium">{e.teaching}</span>
              </div>
              <div className="flex items-center gap-2 my-2">
                <ArrowLeftRight size={12} className="text-[var(--color-shakti-primary)]" />
                <div className="flex-1 h-px bg-[var(--color-shakti-dark-border)]" />
              </div>
              <div className="flex items-center gap-2">
                <span className="text-[10px] text-[var(--color-shakti-primary)] font-semibold uppercase">Wants</span>
