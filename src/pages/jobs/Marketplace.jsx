  ...
  return (
    <div className="min-h-screen bg-[#fdfcff] pb-32 px-4 pt-6 max-w-[960px] mx-auto">
      ...
      <motion.div
        ...
        className="bg-white rounded-3xl p-6 md:p-8 mb-6 shadow-[0_10px_30px_rgba(109,40,217,0.06)] border border-pink-50"
      >
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Women-Owned Marketplace</h1>
            <p className="text-sm text-gray-600">Discover and support women entrepreneurs.</p>
          </div>
        </div>
      </motion.div>
          ...
          >
            ...
            >
              ...
              >
                <Heart
                  size={16}
                  className={favs.includes(l.id) ? 'fill-rose-500 text-rose-500' : 'text-gray-400'}
                />
              </button>
            </div>
            <div className="p-4">
              <div className="flex items-center gap-1 mb-1">
                <span className="px-1.5 py-0.5 rounded-md bg-gray-50 text-gray-600 text-[10px] font-medium">{l.cat}</span>
              </div>
              <h3 className="text-base font-semibold text-gray-900 leading-tight mb-1">{l.name}</h3>
              <p className="text-xs text-gray-500 mb-3">{l.items}</p>
