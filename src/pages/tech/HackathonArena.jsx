    ...
    <div className="min-h-screen bg-[#fdfcff] pb-32 px-4 pt-6 max-w-[960px] mx-auto">
      ...
      >
        <div className="flex items-center gap-5">
          ...
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-1">Hackathon Arena</h1>
            <p className="text-sm text-gray-600">Compete, build, and win with women-only & open hackathons.</p>
          </div>
        </div>
      </motion.div>
          ...
          >
            <div className="flex items-start gap-4 mb-4">
              ...
              <div className="flex-1 min-w-0">
                <h3 className="text-base font-semibold text-gray-900 leading-tight mb-1">{h.title}</h3>
                <p className="text-xs text-gray-500">by {h.sponsor}</p>
              </div>
              {h.status === 'live' && (
            ...
            <div className="grid grid-cols-3 gap-2 mb-4">
              <div>
                ...
                <p className="text-sm font-semibold text-gray-900">{h.daysLeft}</p>
              </div>
              <div>
                <div className="flex items-center gap-1 text-gray-400 mb-1">
                  <IndianRupee size={12} />
                ...
                <p className="text-sm font-semibold text-gray-900">{h.prize}</p>
              </div>
              <div>
                <div className="flex items-center gap-1 text-gray-400 mb-1">
                  <Users size={12} />
                ...
                <p className="text-sm font-semibold text-gray-900">{h.participants}</p>
              </div>
            </div>

            <div className="flex items-center gap-2 mb-4 flex-wrap">
              {h.tags.map(t => (
                <span key={t} className="px-2 py-1 rounded-md bg-gray-50 text-gray-600 text-[10px] font-medium flex items-center gap-1">
                  <Tag size={10} /> {t}
                </span>
              ))}
            </div>
